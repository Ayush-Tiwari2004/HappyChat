    ...
    return (
        <>
            <div className="fixed inset-0 z-50">
                ...
                <div className="absolute bottom-0 left-0 flex h-[600px] divide-x-[1px] divide-slate-700">
                    <div className="w-[400px]">
                        <div className="h-full w-full text-gray-700 dark:text-white bg-white dark:bg-slate-800 flex flex-col gap-2 p-5">
                            ...
                            <div className="flex flex-col gap-2 overflow-y-scroll scrollbar-hide">
                                <div onClick={() => setShowUsersProfileData(!showUsersProfileData)} className="flex justify-between items-center bg-slate-200 dark:bg-slate-700 text-gray-700 dark:text-white p-3 rounded-md cursor-pointer">
                                    <p>Information</p>
                                    <FaChevronRight />
                                </div>
                    ...
                    <div className={`transition-all duration-200 ease-in-out ${showUsersProfileData ? "block w-[400px]" : "opacity-0 w-0"}`}>
